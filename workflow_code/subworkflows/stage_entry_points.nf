include { PARSE_RUNSHEET; mutate_to_single_end; PARSE_TRIMMED_RUNSHEET; PARSE_BAM_RUNSHEET; PARSE_GENES_RESULTS_RUNSHEET; PARSE_COUNTS_TABLE_RUNSHEET } from './parse_runsheet.nf'
