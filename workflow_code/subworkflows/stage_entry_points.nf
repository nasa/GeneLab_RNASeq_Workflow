include { PARSE_RUNSHEET; mutate_to_single_end; PARSE_TRIMMED_RUNSHEET; PARSE_BAM_RUNSHEET; PARSE_GENES_RESULTS_RUNSHEET; PARSE_COUNTS_TABLE_RUNSHEET; PARSE_DGE_TABLE_RUNSHEET } from './parse_runsheet.nf'
...
workflow STAGE_ENTRY_GENES_RESULTS {
    take:
        ch_outdir
        dp_tools_plugin
        accession
...
workflow STAGE_ENTRY_COUNTS_TABLE {
    take:
        ch_outdir
        dp_tools_plugin
        accession
    ...
    main:
        ...
        if ( params.entry_point == "counts_table" && params.runsheet_path == null ) {
            ...
            // Copy/rename counts table to standard location
            COPY_COUNTS_TABLE(ch_outdir, PARSE_COUNTS_TABLE_RUNSHEET.out.counts_table)
...
workflow STAGE_ENTRY_DGE_TABLE {
    take:
        ch_outdir
        dp_tools_plugin
        accession
    ...
    main:
        ...
        if ( params.entry_point == "dge_table" && params.runsheet_path == null ) {
            ...
            // Copy/rename DGE table to standard location
            COPY_DGE_TABLE(ch_outdir, PARSE_DGE_TABLE_RUNSHEET.out.dge_table)
