// RAW_READS_MICROBES_WORKFLOW - Complete microbes workflow starting from raw reads
...
workflow RAW_READS_MICROBES_WORKFLOW {
    ...
    main:
        ...
        // Bowtie2 alignment
        ALIGN_BOWTIE2( ch_outdir.map { it + "/02-Bowtie2_Alignment" }, trimmed_reads, bowtie2_index_dir )
        ...
        ALIGN_MULTIQC( ch_outdir.map { it + "/02-Bowtie2_Alignment/MultiQC_Reports" }, samples_txt, bowtie2_alignment_logs, ch_multiqc_config, "align_")
...
workflow TRIMMED_READS_MICROBES_WORKFLOW {
        take:
        ch_outdir
        dp_tools_plugin
        annotations_csv_url_string
    ...
    main:
        ...
        VV_CONCAT_FILTER( ch_outdir, VV_TRIMMED_READS.out.log | mix( // Concatenate and filter V&V logs
                                                    VV_BOWTIE2_ALIGNMENT.out.log,
                                                    VV_RSEQC.out.log,
                                                    VV_FEATURECOUNTS.out.log,
                                                    VV_DGE_DESEQ2.out.log,
