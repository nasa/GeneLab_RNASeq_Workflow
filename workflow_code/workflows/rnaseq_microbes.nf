include { RAW_READS_MICROBES_WORKFLOW; TRIMMED_READS_MICROBES_WORKFLOW; BAM_FILES_MICROBES_WORKFLOW } from '../subworkflows/rnaseq_microbes_subworkflows.nf'
...
workflow RNASEQ_MICROBES {
    ...
    main:
        ...
        switch(params.entry_point) {
            ...
            case "bam_files":
                println "Executing BAM_FILES_MICROBES_WORKFLOW"
                BAM_FILES_MICROBES_WORKFLOW(
                    ch_outdir,
                    dp_tools_plugin,
                    annotations_csv_url_string,
                    accession,
